        ...
        >
          ...
          <div className="relative w-[92%] m-auto h-full flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="text-white w-full md:w-[50%] space-y-5 ">
              <p className='poppins-medium text-base text-[#3182ED] bg-[#3182ED47] px-3 py-[6px] rounded-[60px] w-fit mt-10 lg:mt-0'>Coming Soon - Early Access Available</p>
              ...
              <button className="bg-[#FFFFFF14] text-white poppins-medium border border-[#FFFFFF] py-3 px-5 text-lg rounded-lg transition">Free Early Sign-up</button>
            </div>
