  ...
  return (
    <section className='w-[92%] m-auto' style={{backgroundColor: bgColor ? bgColor : 'transparent', marginTop: my ? my : 'my-20', marginBottom: my ? my : 'my-20'}}>
        <div className='text-center'>
            ...
            <h3 className='my-1 poppins-semibold text-[30px] md:text-[36px] text-[#333]'>Plans that fit your scale</h3>
        ...
        <MOTION.div
            ...
            {plans.map((plan) => (
                ...
                className={`rounded-[8px] w-full h-fit relative text-center p-8 transition-all duration-300 ease-in-out ${isActive === plan.id ? 'bg-[#3182ED1F] border border-[rgb(49,130,237)] scale-103 shadow-[0px_20px_25px_-5px_#0000001a]' : 'bg-[#F9FAFB] boder border-[#3182ED1F]'}`} onMouseEnter={() => setIsActive(plan.id)} onMouseLeave={() => setIsActive(false)}>
