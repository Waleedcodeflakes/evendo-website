...
const Adoption = ({heading, text, btnText, radius, my}) => {
  ...
  return (
      <AnimatePresence>
        ...
        className='w-[92%] m-auto text-center py-[64px] bg-[#3182ED] px-4' style={{borderRadius: radius ? radius : '0px', marginTop: my ? my : '80px', marginBottom: my ? my : '80px'}} >
        <div className='w-full flex justify-center'>
            <img src={clock} alt="icon" />
        </div>
        <h2 className='poppins-semibold text-[30px] text-[#fff] my-3'>{heading}</h2>
